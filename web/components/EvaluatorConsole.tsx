            ...
            right={
              selectedScore?.final_score != null ? (
                <div className="text-right">
                  <div className="num text-[12px] font-bold text-acc">
                    final {selectedScore.final_score.toFixed(2)}
                  </div>
                  <div className="num text-[10px] text-dim">
                    PnL {selectedScore.pnl_score ?? 0} · DD {selectedScore.drawdown_score ?? 0} · Risk{" "}
                    {selectedScore.risk_score ?? 0} · Cons {selectedScore.consistency_score ?? 0} · Eff{" "}
                    {selectedScore.efficiency_score ?? 0}
                  </div>
                </div>
              ) : undefined
            }
